...
<div id="main">
	<div class="page-header">
		...
		<a href="{{ URL::to('admin/menu') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> Назад</a>
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Категория меню</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">Изображение меню</label>
                    <div class="col-sm-9">
                        <div class="media">
